...
FBTFT_REGISTER_DRIVER(DRVNAME, "solomon,ssd1322w", &display);

MODULE_ALIAS("spi:" DRVNAME);
MODULE_ALIAS("platform:" DRVNAME);
MODULE_ALIAS("spi:ssd1322w");
MODULE_ALIAS("platform:ssd1322w");

MODULE_DESCRIPTION("SSD1322W OLED Driver");
